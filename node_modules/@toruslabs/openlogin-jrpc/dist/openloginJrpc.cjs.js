...
class JRPCEngine extends safeEventEmitter/* default */.Z {
  ...
  async _handle(callerReq, cb) {
    ...
    const req = objectSpread2_default()({}, callerReq);
    const res = {
      id: req.id,
      jsonrpc: req.jsonrpc
    };
...
function providerFromEngine(engine) {
  ...
  provider.request = async args => {
    const req = objectSpread2_default()(objectSpread2_default()({}, args), {}, {
...
/* harmony import */ var _jrpcEngine__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(496);
