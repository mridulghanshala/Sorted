...
__webpack_require__.d(__webpack_exports__, {
  SAPPHIRE_NETWORK_URLS: () => (/* reexport */ SAPPHIRE_NETWORK_URLS),
  fetchLocalConfig: () => (/* reexport */ fetchLocalConfig),
  getRSSEndpoints: () => (/* reexport */ getRSSEndpoints),
  getSSSEndpoints: () => (/* reexport */ getSSSEndpoints),
  getSapphireNodeDetails: () => (/* reexport */ getSapphireNodeDetails),
  getTSSEndpoints: () => (/* reexport */ getTSSEndpoints)
});
...
const SAPPHIRE_NETWORK_URLS = {
  [constants_namespaceObject.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET]: ["https://node-1.dev-node.web3auth.io", "https://node-2.dev-node.web3auth.io", "https://node-3.dev-node.web3auth.io", "https://node-4.dev-node.web3auth.io", "https://node-5.dev-node.web3auth.io"],
  [constants_namespaceObject.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_MAINNET]: ["https://node-1.node.web3auth.io", "https://node-2.node.web3auth.io", "https://node-3.node.web3auth.io", "https://node-4.node.web3auth.io", "https://node-5.node.web3auth.io"]
};
const getSSSEndpoints = (sapphireNetwork, legacyNetwork) => {
  ...
  const routeIdentifier = constants_namespaceObject.LEGACY_NETWORKS_ROUTE_MAP[legacyNetwork];
...
;// CONCATENATED MODULE: ./src/pubKeys.ts

const SAPPHIRE_NODE_PUB_KEYS = {
  [constants_namespaceObject.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_MAINNET]: [{
  ...
  [constants_namespaceObject.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET]: [{
...
;// CONCATENATED MODULE: ./src/sapphireNetworkConfig.ts
...
function fetchLocalConfig(network) {
  if (Object.values(constants_namespaceObject.TORUS_SAPPHIRE_NETWORK).includes(network)) {
    return getSapphireNodeDetails(network);
  }
  if (Object.values(constants_namespaceObject.TORUS_LEGACY_NETWORK).includes(network)) {
    const legacyMap = constants_namespaceObject.LEGACY_NETWORKS_ROUTE_MAP[network];
...
/******/ })()
;
//# sourceMappingURL=fndBase.cjs.js.map